...
ActiveRecord::Schema.define(version: 2020_11_23_074529) do
  ...
  create_table "subscribers", force: :cascade do |t|
    ...
    t.index ["check_in_id"], name: "index_subscribers_on_check_in_id"
    t.index ["member_id"], name: "index_subscribers_on_member_id"
  end
  ...
  add_foreign_key "subscribers", "check_ins"
  add_foreign_key "subscribers", "members"
end
